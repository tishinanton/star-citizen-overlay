		...
		public XmlNode ReadValueAsXml(XmlNode parentNode, DataForgePropertyDefinition propertyDefinition, String nameOverride = null)
		{
			try
			{
				switch (propertyDefinition.DataType)
				{
					...
					case EDataType.varGuid: return parentNode.CreateAttributeWithValue(nameOverride ?? propertyDefinition.Name, Dolkens.Framework.BinaryExtensions.ExtensionMethods.ReadGuid(this.StreamReader, false));
